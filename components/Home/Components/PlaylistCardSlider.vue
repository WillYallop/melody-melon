<template>
    <div class="sliderSeactionContainer">
        <div class="sliderSectionWrapper">

            <!-- Mobile -->
            <div class="playlistPreviewSwiperContainer" v-swiper:mySwiper="swiperOptionMobile">
...
.playlistPreviewSwiperContainer {
    width: 100%;
} 
.playlistPreviewCol {
    padding: 0 10px;
